...
model = tf.keras.models.load_model('./Final Project vgg16/colorize_autoencoder_VGG16[3].models',
                                   custom_objects=None,
                                   compile=True)

# Initializing the testpath and fetching images from that folder
testpath = './Final Project vgg16/dataset/dataset/bw_images'
